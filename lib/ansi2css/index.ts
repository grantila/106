...
const isIE = platform.name.toLowerCase( ) === 'IE';
...
let styleMap: { [ key: string ]: Style; } = null;
...
export function textToParts( text: string )
{
	if ( styleMap === null )
		buildTranslationMap( );
	...
	function partToStyle( part: Style ): CssStyle
	{
		var style: CssStyle = { };
