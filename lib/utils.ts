...
export function timestamp( date = new Date( ), opts?: any )
{
...
export function prettyPrintJson( object: any, opts?: any ): string
{
	opts = opts === undefined ? {} : opts;
...
export type OnTimeout = ( parsedLog: ParsedLog ) => void;
			...
			if ( internal.sequenceDirection )
			{
				...
				if ( direction === 'IN' )
					internal.sequence.begin( ( ) =>
					{
						...
						newMeta.internal = Object.assign(
